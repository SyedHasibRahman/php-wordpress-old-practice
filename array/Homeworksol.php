...
<body>
    <div class="phpcoding">
        ...
        <section class="midcontent">
            ...
            <hr> PHP  array_diff <hr> 
            <?php
define('STATUS',['Y'=>'Booked','N'=>'Not Booked']);//constant
$suborno = [
 'Ka'=>[
 '1'=>'Y',
 '2'=>'N',
...
// define('STATUS',['Y'=>'Booked','N'=>'Not Booked']);//constant
    ...
    echo 'Train Suborno has '.count($suborno).' Bogies';
    $booked = $notBooked = 0;
    foreach ($suborno as $bogie => $sit) {
    echo "<ul>$bogie has ".count($sit)." sit. The sit list details are given below:";
    foreach ($sit as $key => $value) {
    echo "<li>$key is ".STATUS[$value]."</li>";
    if($value == 'Y'){
        $booked +=1;
    }
    if($value == 'N'){
    ...
    echo "Between ".($booked+$notBooked)." sit total booked = $booked and not booked = $notBooked";
    ?>
<!-- Output:
Train Suborno has 6 Bogies
...
 32 is Not Booked
 33 is Not Booked
Between 33 sit total booked = 14 and not booked = 19 -->
